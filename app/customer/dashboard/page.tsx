    ...
    return (
      <div className="min-h-screen bg-background text-foreground">
        ...
        <main className="flex min-h-screen items-center justify-center pt-24">
          <p className="text-muted-foreground">Loading customer account...</p>
        </main>
      </div>
    );
  }
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Manage your purchases, cart, wishlist, feedback, and gallery account in one place.
              </p>
            </div>
        ...
        <section className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-[#eadcc5] bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link
                href="/cart"
                className="rounded-2xl bg-[#f8f3ea] p-5 text-center transition hover:bg-[#efe0c8]"
              >
